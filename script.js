// Displaying our navbar in responsive website
const bar = document.getElementById("bar");
const close = document.getElementById("close");
const nav = document.getElementById("navbar");
const amount = document.getElementById("payment_field");
...
// //We will use AJAX to send request to server to creat order J-Query
...
// fetch('https://api.na.bambora.com/v1').then(response => {
...
//   let response = await fetch('https://demo.bambora.co.nz/interface/api/dts.asmx');
